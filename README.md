...
**Software Architect** based in Taipei, Taiwan 🇹🇼
...
A **Definition-Driven** .NET framework for enterprise app development.

- **Single source of truth** — `FormSchema` drives UI layout, database schema, and validation simultaneously
- **Hybrid architecture** — N-Tier + Clean Architecture + MVVM optimized for ERP scenarios
...
Bee.Core / Bee.Definition / Bee.Api.Contracts
    └── Bee.Db / Bee.Repository
        └── Bee.Business (BO Layer)
            └── Bee.Api.AspNetCore (JSON-RPC 2.0)
                └── Bee.Api.Client (Frontend Connector)
```
...
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=flat&logo=github&logoColor=white)](https://github.com/jeff377)
